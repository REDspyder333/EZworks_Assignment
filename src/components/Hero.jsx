        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="relative order-2 lg:order-1 flex justify-center items-center">
            <div className="relative" style={{ width: '565px', height: '565px' }}>
              {/* Mandala pattern - exact image from design */}
              ...
              {/* Logo - exact image centered over mandala */}
              <div className="absolute inset-0 flex items-center justify-center">
                <img 
                  src="/vfilms-logo.png" 
                  alt="V Films" 
          ...
          <div className="space-y-6 order-1 lg:order-2">
            {/* Headline - Island Moments font, 100px, regular weight, navy blue */}
            <p
            ...
            {/* Films . Brands . Art - exact styling from image */}
            {/* UPDATED: Added justify-center lg:justify-start to match H2 alignment */}
            <div 
            ...
            {/* UPDATED: Added text-center lg:text-left to match H2 alignment */}
            <p 
