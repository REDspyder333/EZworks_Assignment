...
// REMOVED: import Container from './UI/Container';
...
export default function ContactForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Success: set message to "Form Submitted" and disable for 3s + show toast top-right
  ...
  return (
    // REMOVED: Section, Container, and Grid layout
    <>
      {/* Toast */}
      {toast && (
      ...
      {/* REMOVED: All layout classes, bg-white, padding, and shadow to match image */}
      <form ref={formRef} onSubmit={handleSubmit} className="space-y-5" noValidate>
        ...
        {/* ADDED: Centering div for the button */}
